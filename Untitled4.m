...
for i = 1: label_counter
    ...
    centery = round(mean(objecty(i,current_y(:))))
        image(centerx-3:centerx+3,centery-3:centery+3,:)=250;

    
    for pos = 1: length(current_x)
        
%         image(objectx(i,current_x(pos)),objecty(i,current_y(pos)),1)=250;
%         image(objectx(i,current_x(pos)),objecty(i,current_y(pos)),2)=250;
%         image(objectx(i,current_x(pos)),objecty(i,current_y(pos)),3)=250;
    end
